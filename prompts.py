...
4. Курс шақыруы — посттың ең соңында, хэштегтерден БҰРЫН, міндетті түрде мына блок:
   Осы салада маманданғың келсе — қазақ тілінде арнайы курс бар. Сала қаншалықты маңызды екенін айт (1-2 сөйлем), содан соң «📚 Курс туралы толығырақ — @ваш_username» деген шақырумен аяқта.
5. Хэштегтер — соңында 3–5 дана.
...
———
🔥 Бұл сала бүгінгі таңда ең өсіп келе жатқан бағыттардың бірі. Осыны меңгерген адам еңбек нарығында да, бизнесте де бір адым алда болады.

Қазақ тілінде осы тақырып бойынша толық курс бар — нөлден бастап нақты нәтижеге дейін.

📚 Курс туралы толығырақ білу үшін жазыңыз 👉 @vertualdi"""
...
Пост мәтінінің соңына (хэштегтерден бұрын) міндетті түрде мына курс шақыруын қос:{COURSE_CTA}
