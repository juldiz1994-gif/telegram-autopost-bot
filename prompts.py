...
Ұзындық: қатаң 500–1500 таңба (санап тексер!).
...
FORMAT_PROMPTS: dict = {
    "tips": lambda topic, niche: f"""{SYSTEM_PROMPT}
...
Құрылым: завязка → мәселе → шешім → нәтиже.

JSON қайтар:
{{"text": "500-1500 таңбалық пост мәтіні қазақша", "image_prompt": "1-2 sentence minimalist business image description in English"}}
""",

    "checklist": lambda topic, niche: f"""{SYSTEM_PROMPT}
...
Әрбір қадам нөмірленген және етістікпен басталады.
